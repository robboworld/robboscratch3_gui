...
const MODAL_SCENARIOS_LIBRARY = 'scenariosLibrary';
...
const openScenariosLibrary = function () {
    return openModal(MODAL_SCENARIOS_LIBRARY);
};
...
const closeScenariosLibrary = function () {
    return closeModal(MODAL_SCENARIOS_LIBRARY);
};
